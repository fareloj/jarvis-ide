...
contextBridge.exposeInMainWorld('jarvis', {
  ...
  skills: {
    ...
    rollbackReview: (payload) => ipcRenderer.invoke('skills:rollback-review', payload),
    view: (payload) => ipcRenderer.invoke('skills:view', payload),
    export: (payload) => ipcRenderer.invoke('skills:export', payload),
